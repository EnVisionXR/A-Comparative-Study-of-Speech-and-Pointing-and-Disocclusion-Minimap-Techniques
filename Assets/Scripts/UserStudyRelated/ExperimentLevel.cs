...
public class ExperimentLevel : MonoBehaviour
{
    ...
    private List<TargetInteractable> targetInteractables;
    ...
    public void StartLevel(in int randomSeed, in int numTrialsPerLevel)
    {
        ...
        levelInteractables = FindObjectsOfType<Interactable>()
            ...
            .ToList();
        foreach (Interactable levelInteractable in levelInteractables)
        {
            Debug.Log("Level Interactables: " + levelInteractable.name);
        }
        //targetInteractables = FindObjectsOfType<TargetInteractable>().ToList();
    ...
    private void TransitionToNextTrial()
    {
        ...
        Debug.Log("LevelInteractables: " + levelInteractables.Count);
        ...
        Debug.Log("Interactable to replace: " + interactableToReplace.name);
